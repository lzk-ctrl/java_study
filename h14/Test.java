...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String studentListFileName="D:/Programming/eclipseProject/java/javacxsj/src/com/huawei/classroom/student/h14/students.txt";
			// 学生照片存放的目录，不会包含子目录，本目录的pic给出了存放图片的目录示例，实际测试中，pic 位置可能改变，其下面文件数量也会改变
			String picDir="D:/Programming/eclipseProject/java/javacxsj/src/com/huawei/classroom/student/h14/pic/";
			String targetDir="D:/Programming/eclipseProject/java/javacxsj/src/com/huawei/classroom/student/h14/target/";
